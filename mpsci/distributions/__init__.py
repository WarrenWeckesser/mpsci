...
from . import (argus, benktander1, benktander2, beta, betabinomial, betaprime,
               ...
               genpareto, gompertz, gumbel_max, gumbel_min, half_logistic,
               hypergeometric, invchi2, invgamma, invgauss, kumaraswamy,
               laplace, levy, loggamma, logistic, loglogistic, lognormal,
               logseries, maxwell, multivariate_hypergeometric, multivariate_t,
